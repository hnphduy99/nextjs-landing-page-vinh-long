...
async function main() {
  ...
  await prisma.siteSetting.createMany({
    data: [
      { key: 'site_title', value: 'Vĩnh Long - Nhịp Cầu Nối Những Bờ Vui' },
      {
        ...
        value: 'Khám phá vùng đất giữa hai dòng sông, nơi hội tụ văn hóa, lịch sử và thiên nhiên tươi đẹp'
      },
    ...
    data: [
      {
        ...
        description: 'Chúa Nguyễn Phúc Chu cho lập Dinh Long Hồ, đánh dấu sự hình thành chính thức.',
        order: 1
      },
      {
        year: '1832',
        title: 'Tỉnh Vĩnh Long Ra Đời',
        description: 'Vua Minh Mạng chia Nam Kỳ thành 6 tỉnh, Vĩnh Long chính thức trở thành một trong số đó.',
        order: 2
      },
      {
        year: '1945-1975',
        title: 'Hào Khí Cách Mạng',
        description: 'Nhân dân Vĩnh Long viết nên những trang sử oanh liệt trong kháng chiến.',
        order: 3
      },
      {
        year: '1992',
        title: 'Tái Lập Tỉnh Vĩnh Long',
        description: 'Tái lập tỉnh sau thời gian sáp nhập, mở ra chương mới phát triển.',
        order: 4
      }
    ]
  });
  ...
  await prisma.culturalFeature.createMany({
    data: [
      ...
      },
      {
        ...
        description: 'Nét đặc trưng của cư dân vùng sông nước, ăn nói ngay thẳng.',
        icon: 'Smile',
        order: 2
      },
      {
        title: 'Hào Sảng & Nghĩa Hiệp',
        description: 'Sẵn sàng chia sẻ, giúp đỡ lẫn nhau mà không hề toan tính.',
        icon: 'Users',
        order: 3
      }
    ]
  ...
  const vinhLong = await prisma.province.create({
    data: {
      ...
      description: 'Vĩnh Long là một tỉnh nằm ở trung tâm đồng bằng sông Cửu Long...',
        ...
        create: [
          {
            ...
            imageUrl: 'https://images.unsplash.com/photo-1590644365607-1c5a519a7a37?q=80&w=2400',
          ...
          },
          {
            ...
            imageUrl: 'https://images.unsplash.com/photo-1559131397-f94da358f7ca?q=80&w=2400',
        ...
        create: [
          {
            ...
            category: 'fruit',
            description: 'Đặc sản nổi tiếng với múi bưởi hồng tươi, vị ngọt thanh.',
            imageUrl: 'https://images.unsplash.com/photo-1596706107779-9e1b5a7c6c1e?q=80&w=2400',
          ...
          },
          {
            ...
            imageUrl: 'https://images.unsplash.com/photo-1589927986089-35812388d1f4?q=80&w=2400',
